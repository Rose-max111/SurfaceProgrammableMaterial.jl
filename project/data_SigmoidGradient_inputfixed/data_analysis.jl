...
function read_data(expect_width::Float64)
    file_names = readdir("project/data_SigmoidGradient_inputfixed")
    file_data = []
    for file in file_names
        ...
        if width == expect_width
            ...
            velocity = parse(Float64, readline("project/data_SigmoidGradient_inputfixed/$file"))
...
ax1 = Axis(fig[1, 1], xscale = log, yscale = log, title = "moving velocity v.s. depth(SigmoidGradient, input-fixed)", xlabel = "depth", ylabel = "velocity",
